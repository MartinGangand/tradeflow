...
def ar_model_with_max_order_6():
    ar_model = AR(time_series=trade_signs_data, max_order=6, order_selection_method=None, information_criterion=None)
    return ar_model
...
class TestInit:
    ...
    def test_init_max_order_should_raise_exception_when_invalid_max_order(self, max_order):
        with pytest.raises(IllegalNbLagsException) as ex:
            AR(time_series=trade_signs_data, max_order=max_order, order_selection_method=None, information_criterion=None)
    ...
    def test_init_should_raise_exception_when_invalid_order_selection_method(self):
        with pytest.raises(EnumValueException) as ex:
            AR(time_series=trade_signs_data, max_order=6, order_selection_method="invalid_order_selection_method", information_criterion="aic")
    ...
    def test_init_should_raise_exception_when_invalid_information_criterion(self, order_selection_method, information_criterion):
        ...
        with pytest.raises(EnumValueException) as ex:
            AR(time_series=trade_signs_data, max_order=6, order_selection_method=order_selection_method, information_criterion=information_criterion)
...
class TestSelectOrder:
    ...
    def test_select_order_with_selection_method(self, max_order, order_selection_method, information_criterion, expected_order):
        ar_model = AR(time_series=trade_signs_data, max_order=max_order, order_selection_method=order_selection_method, information_criterion=information_criterion)
    ...
    def test_select_order_without_selection_method(self, max_order, information_criterion, expected_order):
        ar_model = AR(time_series=trade_signs_data, max_order=max_order, order_selection_method=None, information_criterion=information_criterion)
        ar_model._select_order()
