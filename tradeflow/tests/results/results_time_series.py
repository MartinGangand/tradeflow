...
class ResultsTimeSeries:
    ...
    def simulation_summary(column_name: str) -> Namespace:
        ...
        index = [
            ...
            "std_nb_consecutive_values",
            "Q50.0_nb_consecutive_values",
            "Q75.0_nb_consecutive_values",
            "Q95.0_nb_consecutive_values",
            "Q99.0_nb_consecutive_values",
            "Q99.9_nb_consecutive_values",
        ]
        statistics = [
            1000.0,
            64.0,
