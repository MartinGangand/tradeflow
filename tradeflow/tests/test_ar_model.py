...
class TestFit:
    ...
    def test_fit(self, ar_model_with_max_order_6, method, num_regression):
        ar_model_with_max_order_6.fit(method=method.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=True, check_residuals_not_autocorrelated=True)
    ...
    def test_fit_should_raise_exception_when_invalid_method(self, ar_model_with_max_order_6, method):
        ...
        with pytest.raises(EnumValueException) as ex:
            ar_model_with_max_order_6.fit(method=method, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=True, check_residuals_not_autocorrelated=True)
    ...
    def test_fit_should_raise_exception_when_time_series_is_non_stationary_and_check_stationarity_is_true(self, ar_model_non_stationary_with_max_order_1):
        with pytest.raises(NonStationaryTimeSeriesException) as ex:
            ar_model_non_stationary_with_max_order_1.fit(method=FitMethodAR.YULE_WALKER.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=True, check_residuals_not_autocorrelated=False)
    ...
    def test_fit_should_not_raise_exception_when_time_series_is_non_stationary_and_check_stationarity_is_false(self, mocker, ar_model_non_stationary_with_max_order_1):
        ...
        ar_model_non_stationary_with_max_order_1.fit(method=FitMethodAR.YULE_WALKER.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=False, check_residuals_not_autocorrelated=False)
    ...
    def test_fit_should_raise_exception_when_residuals_are_autocorrelated_and_check_residuals_not_autocorrelated_is_true(self, mocker, ar_model_with_max_order_6):
        ...
        with pytest.raises(AutocorrelatedResidualsException) as ex:
            ar_model_with_max_order_6.fit(method=FitMethodAR.YULE_WALKER.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=False, check_residuals_not_autocorrelated=True)
    ...
    def test_fit_should_not_raise_exception_when_residuals_are_autocorrelated_and_check_residuals_not_autocorrelated_is_false(self, mocker, ar_model_with_max_order_6):
        ...
        ar_model_with_max_order_6.fit(method=FitMethodAR.YULE_WALKER.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=False, check_residuals_not_autocorrelated=False)
...
class TestSimulate:
    ...
    def fitted_model(self, ar_model_with_max_order_6):
        return ar_model_with_max_order_6.fit(method=FitMethodAR.YULE_WALKER.value, significance_level=SIGNIFICANCE_LEVEL, check_stationarity=True, check_residuals_not_autocorrelated=True)
