import numpy as np
import pytest
from numpy.testing import assert_almost_equal, assert_allclose, assert_equal, assert_array_almost_equal
...
class TestGetModelXY:
    ...
    def test_get_model_x_y_without_cst_parameter(self):
        ...
        expected_y = np.asarray([[4.],
                                 ...
                                 [7.],
                                 [8.]])
        assert_equal(actual_x, desired=expected_x)
        assert_equal(actual_y, desired=expected_y)
...
class TestLogLikelihood:
    ...
    def test_calculate_vp_inv(self, ar_model_with_max_order_6, has_cst_parameter, parameters):
        ...
        assert_array_almost_equal(x=actual_vp_inv, y=expected_vp_inv, decimal=15)
...
class TestSimulationSummary:
    ...
    @pytest.mark.parametrize("fit_method", [FitMethodAR.YULE_WALKER, FitMethodAR.BURG, FitMethodAR.OLS_WITH_CST, FitMethodAR.MLE_WITHOUT_CST, FitMethodAR.MLE_WITHOUT_CST])
