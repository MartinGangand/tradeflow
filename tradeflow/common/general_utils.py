...
def check_enum_value_is_valid(enum_obj: enum, value: object | None, is_none_valid: bool, parameter_name: str) -> enum.Enum | None:
    """
...
def is_value_within_interval_exclusive(
    value: int | float,
